...
# firefly = Motor('Firefly')
# argo = Carro('Argo Trekking')
# argo.motor = firefly
# argo.fabricante = fiat

# print(f'Nome: {argo.nome}')
# print(f'Motor: {argo.motor.nome}')
# print(f'Fabricante: {argo.fabricante.nome}')
